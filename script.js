...
//Function to determine whether the user wants to include uppercase characters in the password
...
//Function to determine whether the user wants to include numbers in the password
...
//Function to determine whether the user wants to include special characters in the password
function determineSpecial(){
 ...
 //Function to take all the input from the previous functions and generate a password using a random number generator and 
 //the charAt method 
